...
https://docs.google.com/document/d/19Lhj_rfjMAbb5LIQeCCCUw9HEbb8PuvCno5ZkWziERY/edit?usp=sharing
...
6. **Meta Business Managers Snapshot** - Business manager information with history
7. **Meta Ad Accounts** - Ad accounts from Meta Business Manager
8. **Meta Ad Accounts Snapshot** - Ad account information with history
9. **Meta Metrics** - Daily advertising statistics (spend, impressions, etc.)
10. **Meta Campaigns** - Campaign information and management
11. **Meta Campaigns Snapshot** - Campaign information with history
12. **Meta Ad Sets** - Ad set information for campaigns
13. **Meta Ad Sets Snapshot** - Ad set information with history
14. **Meta Ads** - Ad information for campaigns
15. **Meta Ads Snapshot** - Ad information with history
...
├── migraine/           # Migrator app from postgres to mongodb
